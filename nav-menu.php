       		...
       		<label for="menu" class="toggleMenu"><img src="images/cover/logo1.png" width="30px" height="30px" title="logo"><!-- <i class="fa-solid fa-bars"></i> --></label>
       		   ...
       		   <ul class="nav">
					...
					<li> <a href=# class="style-arch-link">Стилі архітектури</a>
							<ul>
									<li><a href="art-deco.php" class="art-deco">Арт Деко</a></li>
									<li><a href="baroque.php" class="baroque">Бароко</a></li>
									<li><a href="gothic.php" class="gothic">Готика</a></li>							
									<li><a href="islamic.php" class="іslamic">Ісламська</li>
									<li><a href="modern.php" class="modernism">Модернізм</li>
									<li><a href="parametric.php" class="parametric">Параметризм</li>
									<li><a href="renaissanse.php" class="renaissanse">Ренесанс</li>
									<li><a href="futurism.php" class="futurism">Футурізм</li>
							</ul>
					</li>
					<li> <a href="architects.php" class="arch-link">Архітектори</li>					
